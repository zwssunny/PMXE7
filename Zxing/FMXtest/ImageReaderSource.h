...
class ImageReaderSource : public LuminanceSource {
private:
...
public:
  static Ref<LuminanceSource> create(std::string const& filename);
  static Ref<LuminanceSource> create(const unsigned char* in, size_t insize);
