...
{支持中国式日期格式}
  ...
  UserfmtSettings:=TFormatSettings.Create;
  UserfmtSettings.DateSeparator   := '-';
	UserfmtSettings.TimeSeparator   := ':';
	UserfmtSettings.ShortDateFormat := 'yyyy-MM-dd';
	UserfmtSettings.ShortTimeFormat := 'HH:mm:ss';
