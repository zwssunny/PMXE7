...
private:	// User declarations
	...
	void __fastcall DoDeleteDetail(System::Uitypes::TModalResult AResult);
	void __fastcall DoBalanceGen(System::Uitypes::TModalResult AResult);
	void __fastcall DoGenAdjBill(System::Uitypes::TModalResult AResult);
