...
private:
	...
	void __fastcall SetDetailDataSetAfterPost(TDataSetNotifyEvent value);
	TDataSetNotifyEvent __fastcall GetDetailDataSetAfterPost();
...
//	void __fastcall ValidField(TValidType vt,TValidAffect va);
	...
	__property TDataSetNotifyEvent DetailDataSetAfterPost = {read=GetDetailDataSetAfterPost, write=SetDetailDataSetAfterPost};
