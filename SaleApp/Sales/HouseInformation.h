...
__published:	// IDE-managed Components
	...
	void __fastcall UnitExpanderResize(TObject *Sender);
...
public:		// User declarations
	__fastcall THouseInformationForm(TComponent* Owner,TClientBroker * clBroker,int ModuleCode,TZClientDataSet
