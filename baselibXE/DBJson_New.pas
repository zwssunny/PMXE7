...
type
  ...
  public
    ...
    // AType:0-新增OldData;1-用新值替换旧值NewData
...
begin
  ...
  try
    // 将JSON中的OldData新增到数据集中
    // 编辑当前记录，将JSON中的NewData替换记录中的值，
    // ADO在ltBatchOptimistic模式下会自动备份原记录值到ADO的OldData中
    if AType=0 then
    begin
