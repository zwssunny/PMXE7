...
// ---------------------------------------------------------------------------
int GetModuleSize(int dwLicKey) // 返回压缩后的数据大小
{
	HANDLE hFind;
	WIN32_FIND_DATA wfd;
	Char szFilePath[255];
...
// ---------------------------------------------------------------------------
int GetModuleActualSize(int dwLicKey) // 返回解压后的数据大小
{
	int ret, addr, size;
...
// ---------------------------------------------------------------------------
int GetWindowSize(int dwLicKey) // 返回压缩后的数据大小
{
	HANDLE hFind;
	WIN32_FIND_DATA wfd;
	Char szFilePath[255];
...
// ---------------------------------------------------------------------------
int GetWindowActualSize(int dwLicKey) // 返回解压后的数据大小
{
	int ret, addr, size;
