...
//  TZXingScanMode = (smSCAN_MODE,smPRODUCT_MODE, smONE_D_MODE,smQR_CODE_MODE,smDATA_MATRIX_MODE );
  TZXingScanMode = (smSCAN_MODE, smONE_D_MODE,smQR_CODE_MODE );
  IZXing = interface
...
//    ZXing_CodeModes: array[TZXingScanMode] of string = ('SCAN_MODE','PRODUCT_MODE','ONE_D_MODE', 'QR_CODE_MODE', 'DATA_MATRIX_MODE');
    ZXing_CodeModes: array[TZXingScanMode] of string = ('SCAN_MODE','ONE_D_MODE','QR_CODE_MODE');
    ZXing_RequestCode = 0;
  protected
    constructor Create;
  public
