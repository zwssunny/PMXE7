...
resourcestring
sAlignleftedges =          '¿¿×ó¶ÔÆë';
sAlignrightedges =         '¿¿ÓÒ¶ÔÆë';
sAligntopedges =           'ÉÏ¶ÔÆë';
sAlignbottomedges =         'ÏÂ¶ÔÆë';
sAlignhorizontalcenters =   'Ë®Æ½¾ÓÖÐ';
sAlignverticalcenters =     'ÊúÏò¾ÓÖÐ';
sMakesamewidth =            'Í¬¿í¶È';
sMakesameheight =           'Í¬¸ß¶È';
sMakesamesize =             'Í¬´óÐ¡';
sSpaceequallyhorizontally = 'Ë®Æ½Æ½¾ù¼ä¾à';
sSpaceequallyvertically =   'ÊúÏòÆ½¾ù¼ä¾à';
sIncrementhorizontalspace = 'Ôö´óË®Æ½¼ä¾à';
sIncrementverticalspace =   'Ôö´óÊúÏò¼ä¾à';
sDecrementhorizontalspace = '¼õÉÙË®Æ½¼ä¾à';
sDecrementverticalspace =   '¼õÉÙÊúÏò¼ä¾à';
