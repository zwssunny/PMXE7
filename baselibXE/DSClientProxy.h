...
#include "Data.DBXCDSReaders.hpp"
  ...
  class THouseViewClient : public TObject
  {
  private:
    TDBXConnection *FDBXConnection;
    bool FInstanceOwner;
    TDBXCommand *FGetHouseViewStreamCommand;
    TDBXCommand *FUpdateHouseViewFileCommand;
  public:
    __fastcall THouseViewClient(TDBXConnection *ADBXConnection);
    __fastcall THouseViewClient(TDBXConnection *ADBXConnection, bool AInstanceOwner);
    __fastcall ~THouseViewClient();
    TStream* __fastcall GetHouseViewStream(System::UnicodeString AKeyID);
    bool __fastcall UpdateHouseViewFile(System::UnicodeString AKeyID, System::UnicodeString AFileName, TStream* AStream);
  };

  class TSendUserMessageClient : public TObject
  {
  private:
    TDBXConnection *FDBXConnection;
    bool FInstanceOwner;
    TDBXCommand *FSendUserMessageCommand;
  public:
    __fastcall TSendUserMessageClient(TDBXConnection *ADBXConnection);
    __fastcall TSendUserMessageClient(TDBXConnection *ADBXConnection, bool AInstanceOwner);
    __fastcall ~TSendUserMessageClient();
    void __fastcall SendUserMessage(int type, System::UnicodeString AID);
  };
