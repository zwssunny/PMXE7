...
// (DO NOT EDIT: machine generated header) 'PropFilerBY.pas' rev: 6.00

#ifndef PropFilerBYHPP
#define PropFilerBYHPP
...
namespace Propfilerby
{
//-- type declarations -------------------------------------------------------
class DELPHICLASS TPropWriterBY;
typedef void __fastcall (__closure *TWriteOwnerPropsEventBY)(TPropWriterBY* Writer);

class DELPHICLASS TPropReaderBY;
typedef void __fastcall (__closure *TReadOwnerPropEventBY)(TPropReaderBY* Reader, AnsiString PropName, bool &Processed);

class PASCALIMPLEMENTATION TPropWriterBY : public Classes::TWriter 
{
...
private:
	...
	TWriteOwnerPropsEventBY FOnWriteOwnerProps;
...
public:
	__fastcall TPropWriterBY(Classes::TStream* Stream, int BufSize);
	__fastcall virtual ~TPropWriterBY(void);
	...
	__property TWriteOwnerPropsEventBY OnWriteOwnerProps = {read=FOnWriteOwnerProps, write=FOnWriteOwnerProps};
};


class PASCALIMPLEMENTATION TPropReaderBY : public Classes::TReader 
{
...
private:
	...
	TReadOwnerPropEventBY FOnReadOwnerProp;
	HIDESBASE int __fastcall ReadSet(void * SetType);
...
protected:
	...
	HIDESBASE void __fastcall ReadPropValue(Classes::TPersistent* Instance, void * PropInfo);
	
public:
	__fastcall TPropReaderBY(Classes::TStream* Stream, int BufSize);
	__fastcall virtual ~TPropReaderBY(void);
	virtual void __fastcall DefineBinaryProperty(const AnsiString Name, Classes::TStreamProc ReadData, Classes::TStreamProc WriteData, bool HasData);
	virtual void __fastcall DefineProperty(const AnsiString Name, Classes::TReaderProc ReadData, Classes::TWriterProc WriteData, bool HasData);
	...
	__property TReadOwnerPropEventBY OnReadOwnerProp = {read=FOnReadOwnerProp, write=FOnReadOwnerProp};
};
...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE bool IsRaiseReadErrorBY;
extern PACKAGE void __fastcall GetComponentChildListBY(Classes::TComponent* ParentComp, Classes::TComponent* Root, Classes::TStrings* cl, bool CheckInline);
