...
TDecodeQueueProc::TDecodeQueueProc(TOnDecodeResults &AOnDecodeResults,TBitmap *FImage,bool Ahybrid)
{
  FOnDecodeResults=AOnDecodeResults;
  Fhybrid= Ahybrid;
  Source=ImageToLuminanceSource(FImage);
}
...
TDecodeQueueProc::TDecodeQueueProc(TOnDecodeResults &AOnDecodeResults,UnicodeString filename,bool Ahybrid)
{
  FOnDecodeResults=AOnDecodeResults;
  Fhybrid= Ahybrid;
  Source=BarcodePicToLuminanceSource(filename);
}
//---------------------------------------------------------------------------
